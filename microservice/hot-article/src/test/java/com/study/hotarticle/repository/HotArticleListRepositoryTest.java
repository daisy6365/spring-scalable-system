...
class HotArticleListRepositoryTest {
    ...
    void addTest() throws InterruptedException {
        // given
        LocalDateTime time = LocalDateTime.of(2026, 3, 3, 0, 0);
        long limit = 3; // 상위 3건
        ...
        // then
        List<Long> articleIds = hotArticleListRepository.readAll("20260303");
        ...
        assertThat(hotArticleListRepository.readAll("20260303")).isEmpty();
    }
